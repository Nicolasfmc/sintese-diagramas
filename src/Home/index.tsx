    ...
    <>
      ...
      <Box>
        ...
        >
          ...
          <Typography variant="h5" style={{ margin: 20, paddingTop: 10, fontWeight: 'bold' }} color={'white'}>
            Diagrama Estrutural
          </Typography>
          ...
          <Typography variant="h5" style={{ margin: 20, fontWeight: 'bold' }} color={'white'}>
          ...
          <Grid container spacing={2} columns={4} style={{ margin: 20 }}>
            ...
            <Grid item xs={1} style={{ paddingBottom: 20 }}>
              <MediaCard
